...
!----------------------------------------------------------------------
!
! MODULE(S) REQUIRED: ext_functions.f
!
!---------------------------------------------------------------
!
! USE:
...
! 01/05/2008      0.4             R.Capote         RIPL-3 released
!---------------------------------------------------------------
!
...
C
      ...
      REAL*8 FUNCTION DOM_INT_Ws(Ef,Ep,As,Bs,Cs,Einc,m,DerivIntWs)
C
C      Analytical dispersive integral and its derivative for
